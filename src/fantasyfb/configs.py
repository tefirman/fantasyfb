...
various fantasy platforms like DraftKings, Underdog, etc.
"""
...
# range -- so the other 'FG *-*' keys below are unused; kept populated for
# schema completeness.
...
def get_league_config(platform: str):
    ...
    Args:
        platform: Platform name ('draftkings'/'dk', 'underdog',
    ...
    if platform_lower in ['dk', 'draftkings']:
